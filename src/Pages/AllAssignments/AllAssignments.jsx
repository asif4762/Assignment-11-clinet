...
const AllAssignments = () => {
    ...
    const url = `https://assignment-11-server-xi-flame.vercel.app/difficulty-assignments?difficulty_level=Medium`;
    const url_1 = `https://assignment-11-server-xi-flame.vercel.app/assignments`;
    ...
    const handleEasy = (t) => {
        setUserData(null);
        fetch(`https://assignment-11-server-xi-flame.vercel.app/difficulty-assignments?difficulty_level=${t}`)
        .then(res => res.json())
        .then(data => setUserData(data))
    }
